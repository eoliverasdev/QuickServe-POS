...
9. Problemes durant el desenvolupament
10. Seguiment diari
11. Conclusions
12. Bibliografia
...
## 14. Annexos de suport tècnic i evidència
...
## 15. Arquitectura tècnica detallada

### 15.1 Visió general d'arquitectura
...
### 15.3 Lògica de comandes i consistència
...
### 15.4 Flux d'encàrrecs pendents
...
## 16. Diccionari de dades i model relacional ampliat
...
### 16.5 Taula pivot `category_product`
...
### 16.9 Taula `personal_access_tokens`

Persistència de tokens Sanctum per autenticació API.

### 16.10 Regles d'integritat clau
...
## 17. Especificació funcional endpoint per endpoint
...
## 18. Matriu de traçabilitat de requisits i implementació
...
### 19.2 Casos de prova suggerits (ampliables)
...
## 20. Pla de desplegament i operació

### 20.1 Entorn local de desenvolupament
...
### 20.2 Procés de pas a producció
...
### 20.3 Riscos operatius i mitigacions
...
## 21. Pla de qualitat i manteniment

### 21.1 Qualitat de codi
...
## 22. Dietari del desenvolupament
...
## 23. Annex de proves funcionals complet
...
### 23.3 Proves de seqüència operativa completa
...
## 24. Síntesi documental del projecte
...
## 25. Desenvolupament narratiu ampliat del projecte

### 25.1 Del problema real a la definició del producte
...
### 25.2 Decisió d'arquitectura i impacte en la mantenibilitat
...
### 25.3 Evolució d'abast: de mòdul puntual a sistema operatiu
...
### 25.4 Disseny del flux de comandes i encàrrecs
...
### 25.5 Control d'estoc com a eix de fiabilitat
...
### 25.6 Mòdul administratiu i valor de gestió
...
### 25.7 Seguretat aplicada al context del projecte
...
### 25.8 Aprenentatges tècnics i metodològics
...
### 25.9 Impacte operatiu i valor pràctic
...
### 25.10 Línies futures amb justificació
